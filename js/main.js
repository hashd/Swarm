...
function loadJSObj(jsVal){
  ...
  switch (jsVal){
    case "Feeds":
          jsObj = new Swarm.Feeds();
          break;
    case "Messages":
          jsObj = new Swarm.Messages();
          break;
    case "Analytics":
          jsObj = new Swarm.Analytics();
          break;
    case "Postmessage":
          jsObj = new Swarm.Postmessage();
          break;
    case "Activityfeed":
          jsObj = new Swarm.ActivityFeed();
          break;
    case "Notifications":
          jsObj = new Swarm.Notifications();
          break;
  }
  return jsObj;
}
